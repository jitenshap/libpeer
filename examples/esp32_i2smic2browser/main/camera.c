...
#if defined(CONFIG_ESP32_BOARD_MODEL) && defined(CONFIG_ESP32S3_XIAO_SENSE)
...
#elif defined(CONFIG_ESP32_BOARD_MODEL) && defined(CONFIG_ESP32_M5STACK_CAMERA_B)
#define CAM_PIN_PWDN -1
...
#elif defined(CONFIG_ESP32_BOARD_MODEL) && defined(CONFIG_ESP32S3_EYE)
#define CAM_PIN_PWDN -1
#define CAM_PIN_RESET -1
